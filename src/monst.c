 ...
 *	  little dog/big dog, baby naga/full-grown naga. Other than this,
 *	  the combination of monster class and color should be unique!
 *
...
/*      ants    */
        ...
        { "queen bee", S_ANT, 9, 24, -6, 0, 0, (G_GENO | G_NOGEN),
          ...
          1, 10, 0, MS_BUZZ, M1_VSMALL | M1_ANIMAL | M1_FLY | M1_NOHANDS |
          M1_POIS | M1_POIS_RES | M1_PRINCE, M2_HOSTILE, C(MAGENTA) },
/*      blobs   */
...
/*      dog     */
        { "little dog", S_DOG, 2, 18, 6, 0, 0, (G_GENO | 1),
          ...
          15, 150, 0, MS_BARK,
          M1_VSMALL | M1_ANIMAL | M1_NOHANDS, M2_CARNIVORE, C(BLUE) },
	  ...
	  C(BLUE) },
        ...
        { "jackalwere", S_DOG, 2, 12, 7, 10, -7, G_NOGEN | G_NOCORPSE,
          ...
          M1_REGEN, M2_HOSTILE | M2_CARNIVORE, C(BROWN) },
...
/*      felines         */
        { "kitten", S_FELINE, 2, 18, 6, 0, 0, (G_GENO | 1),
          ...
          M2_WANDER | M2_CARNIVORE, C(BLUE) },
        { "housecat", S_FELINE, 4, 16, 5, 0, 0, (G_GENO | 1),
          { { AT_BITE, AD_PHYS, 1 ,6 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          20, 200, 0, MS_MEW, M1_ANIMAL | M1_NOHANDS, M2_CARNIVORE, C(BLUE) },
...
/*      humanoids       */
        ...
        { "hobbit", S_HUMANOID, 1, 9, 7, 0, 6, (G_GENO | 2),
          { { AT_WEAP, AD_PHYS, 1, 6 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          20, 200, 0, MS_HUMANOID, M1_HUMANOID | M1_COLLECT, 0, C(HI_MON) },
#endif
        ...
        { "dwarf", S_HUMANOID,  2, 6, 4, 10, 4, (G_GENO | 3),
          ...
          M1_COLLECT, M2_DWARF | M2_TUNNEL | M2_NEEDPICK | M2_STRONG, C(HI_MON)},
        ...
        { "dwarf king", S_HUMANOID,  6, 6, 4, 20, 6, (G_GENO | 1),
          ...
          M2_DWARF | M2_TUNNEL | M2_NEEDPICK | M2_STRONG, C(MAGENTA) },
/*      imps & other minor demons/devils */
        { "manes", S_IMP, 1, 3, 7, 0, -7, (G_GENO | G_LGROUP | G_NOCORPSE | 1),
          ...
          10, 100, 0, MS_JEER, M1_VSMALL | M1_POIS | M1_STALK, 0, C(RED) },
        { "homunculus", S_IMP, 2, 12, 6, 10, -7, (G_GENO | 2),
          ...
          M1_SLEE_RES | M1_STALK, 0, C(GREEN) },
...
/*      orcs    */
        { "goblin", S_ORC,  0, 6, 6, 0, -3, (G_GENO | 2),
          { { AT_WEAP, AD_PHYS, 1, 4 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          10, 100, 0, MS_ORC, M1_HUMANOID | M1_COLLECT, M2_ORC, C(YELLOW) },
...
/*      spiders and scorpions   */
        { "cave spider", S_SPIDER, 1, 12, 3, 0, 0, (G_GENO | G_SGROUP | 2),
          ...
          M1_POIS_RES, M2_HOSTILE | M2_CONCEAL | M2_CARNIVORE, C(WHITE) },
        { "scorpion", S_SPIDER, 5, 15, 3, 0, 0, (G_GENO | 2),
          ...
          M1_POIS, M2_HOSTILE | M2_CONCEAL | M2_CARNIVORE, C(RED) },
...
/*      worms   */
        ...
        { "baby long worm", S_WORM, 8, 3, 5, 0, 0, G_GENO,
          ...
          M2_NOLIMBS | M2_CARNIVORE, C(BROWN) },
#endif
        { "baby purple worm", S_WORM, 8, 3, 5, 0, 0, G_GENO,
          { { AT_BITE, AD_PHYS, 1, 6 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          25, 250, 0, MS_SILENT, M1_ANIMAL | M1_NOHANDS, M2_HOSTILE |
          M2_NOLIMBS | M2_CARNIVORE, C(MAGENTA) },
#ifdef WORM
...
/*      Gnomes  */
        { "gnome", S_GNOME, 1, 6, 5, 4, 0, (G_GENO | G_SGROUP | 1),
          { { AT_WEAP, AD_PHYS, 1, 6 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          10, 100, 0, MS_ORC, M1_HUMANOID | M1_COLLECT, 0, C(HI_MON) },
        { "gnome lord", S_GNOME, 3, 8, 4, 4, 0, (G_GENO | 2),
          { { AT_WEAP, AD_PHYS, 1, 8 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          15, 120, 0, MS_ORC, M1_HUMANOID | M1_COLLECT | M1_LORD, 0, C(HI_MON) },
	  ...
	  C(MAGENTA)},
        { "gnomish wizard", S_GNOME, 3, 10, 4, 10, 0, (G_GENO | 1),
          { { AT_MAGC, AD_SPEL, 0, 0 }, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          15, 120, 0, MS_ORC, M1_HUMANOID | M1_MAGIC, 0, C(HI_MON) },
#ifdef SPLITMON_1
};
#endif
#endif /* !SPLITMON_2 */
...
/*      Vampires        */
        { "vampire", S_VAMPIRE, 10, 12, 1, 25, -8, (G_GENO | 1),
          ...
          M1_STALK, M2_HOSTILE | M2_STRONG | M2_NASTY, C(HI_MON) },
        ...
        { "Vlad the Impaler", S_VAMPIRE, 14, 18, -3, 80, -10,
          ...
          M2_HOSTILE | M2_PNAME | M2_STRONG | M2_NASTY, C(MAGENTA) },
/*      Wraiths         */
...
/*      Zombies         */
        ...
        { "orc zombie", S_ZOMBIE, 2, 6, 9, 0, -3,
          ...
          M1_STALK | M1_GREEDY | M1_JEWELS, M2_HOSTILE | M2_ORC, C(BROWN) },
        { "elf zombie", S_ZOMBIE, 3, 6, 9, 0, -3,
          ...
          M1_STALK | M1_SLEE_RES, M2_HOSTILE | M2_ELF, C(HI_MON) },
...
/*      Humans          */
        ...
        { "elf-lord", S_HUMAN, 8, 12, 5, 20, 9, (G_GENO | G_SGROUP | 2),
          ...
          M1_SLEE_RES, M2_ELF | M2_STRONG, C(HI_MON) },
        ...
        { "Wizard of Yendor", S_HUMAN, 30, 12, -8, 100, -20, G_NOGEN,
          ...
          M2_HUMAN | M2_PNAME | M2_HOSTILE | M2_STRONG | M2_NASTY, C(MAGENTA)
	  },
#ifdef MEDUSA
...
/*      (major) Demons  */
        { "water demon", S_DEMON, 8, 12,-4, 30, -7, (G_NOCORPSE | G_NOGEN),
          ...
          M1_STALK | M1_COLLECT, M2_DEMON | M2_HOSTILE | M2_NASTY, C(BLUE) },
        ...
        { "marilith", S_DEMON, 7, 12, -6, 80, -12, (G_HELL | G_NOCORPSE | 1),
          ...
          M1_FEM, M2_DEMON | M2_HOSTILE | M2_NASTY, C(RED) },
	  ...
	  C(WHITE) },
        { "pit fiend", S_DEMON, 13, 6, -3, 65, -13, (G_HELL | G_NOCORPSE | 2),
          ...
          M1_COLLECT, M2_DEMON | M2_HOSTILE | M2_NASTY, C(RED) },
	  ...
	  C(BRIGHT|GREEN) },
        { "Yeenoghu", S_DEMON, 56, 18, -5, 80, -15,
          ...
          M2_DEMON | M2_HOSTILE | M2_PNAME | M2_NASTY, C(MAGENTA) },
...
/*      eels            */
        { "giant eel", S_EEL, 5, 9, -1, 0, 0, (G_GENO | G_NOGEN),
          ...
          M1_EGGS, M2_HOSTILE | M2_NOLIMBS | M2_CARNIVORE, C(CYAN) },
...
/*      character classes */
        ...
        { "barbarian", S_HUMAN, 1, 10, 10, 1, -3, G_NOGEN,
          { {AT_WEAP, AD_PHYS, 1, 6}, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          45, 400, 0, MS_HUMANOID, M1_NOPOLY | M1_HUMANOID | M1_COLLECT |
          M1_POIS_RES, M2_HUMAN | M2_STRONG, C(HI_MON) },
        ...
        { "elf", S_HUMAN, 1, 12, 10, 2, 3, G_NOGEN,
          ...
          M1_SLEE_RES | M1_SEE_INVIS, M2_ELF | M2_STRONG, C(HI_MON) },
        ...
        { "rogue", S_HUMAN, 1, 10, 10, 1, -3, G_NOGEN,
          { {AT_WEAP, AD_PHYS, 1, 6}, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          45, 400, 0, MS_HUMANOID, M1_NOPOLY | M1_HUMANOID | M1_COLLECT |
          M1_GREEDY, M2_HUMAN | M2_STRONG, C(HI_MON) },
        ...
        { "valkyrie", S_HUMAN, 1, 10, 10, 1, -1, G_NOGEN,
          { {AT_WEAP, AD_PHYS, 1, 8}, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK },
          45, 400, 0, MS_HUMANOID, M1_NOPOLY | M1_HUMANOID | M1_COLLECT | 
          M1_COLD_RES | M1_FEM, M2_HUMAN | M2_STRONG, C(HI_MON) },
