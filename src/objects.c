...
/* food CORPSE is a cadaver of some type */
	...
	FOOD("fortune cookie",      55, 1,  1, 0, VEGGY,  40, BROWN),
	FOOD("pancake",             25, 2,  2, 0, VEGGY, 200, BROWN),
...
SPELL("healing",         "white",       40,  2, 1, 1, NODIR,     WHITE),
...
SPELL("extra healing",   "plaid",       35,  5, 3, 1, NODIR,     GREEN),
